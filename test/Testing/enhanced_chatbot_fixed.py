...
def main():
    ...
    chatbot = HybridRAGChatbot(verbose=False, log_file="chatbot_activity.log")

    # Test queries
    test_queries = [
        "How many different colors are listed in the dataset?",  # Semantic
        "What is the color of the 2 oz Amber Frosted Glass Boston Round Bottle?",   # Structured
        "How many products are categorized under 'Glass'?",            # Hybrid
        "What is the average capacity (in ml) of products colored Cobalt Blue?",                            # Out of scope
    ]
